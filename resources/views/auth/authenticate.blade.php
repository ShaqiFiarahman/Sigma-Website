...
<head>
    ...
    <title>SIGMA - Portal Mitigasi Bencana & Tanggap Darurat Real-Time</title>
    <meta name="description"
        content="Portal kebencanaan SIGMA: Pantau peta bencana real-time, laporkan kejadian darurat secara cepat, temukan posko evakuasi terdekat, dan bergabung sebagai relawan.">
    <meta name="keywords"
    ...
    <div class="auth-card {{ old('name') ? 'right-panel-active' : '' }}" id="authCard">
        ...
        <div class="form-container sign-up-container">
            <form action="{{ route('register.post') }}" method="POST"
                ...
                <p class="mobile-toggle hidden mt-6 text-center text-sm text-slate-500">
                    Sudah punya akun? <button type="button" class="text-accent font-bold"
                        onclick="togglePanel()">Masuk</button>
                </p>
            </form>
        </div>
                ...
                <div class="flex items-center justify-between mt-4 mb-6">
                    <label class="flex items-center gap-2.5 cursor-pointer group select-none">
                        <div class="relative w-4 h-4 flex items-center justify-center">
                            ...
                            <div
                                class="absolute inset-0 rounded-md border border-slate-200 bg-slate-50 transition-all duration-200 peer-checked:bg-blue-600 peer-checked:border-blue-600 group-hover:border-slate-300 shadow-sm">
                            </div>
                            <i
                                class="bi bi-check text-white text-[14px] leading-none z-10 scale-0 peer-checked:scale-100 transition-transform duration-200"></i>
                        </div>
                        <span
                            class="text-xs text-slate-500 font-medium group-hover:text-slate-600 transition-colors">Ingat
                            saya</span>
                    </label>
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <svg class="absolute inset-0 w-full h-full opacity-[0.05] pointer-events-none"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" preserveAspectRatio="none">
                    <path d="M-100,100 C200,50 300,250 500,100 C700,0 800,200 900,100" fill="none" stroke="white"
                        stroke-width="2" />
                    <path d="M-100,150 C200,100 300,300 500,150 C700,50 800,250 900,150" fill="none" stroke="white"
                        stroke-width="1.8" />
                    <path d="M-100,200 C200,150 300,350 500,200 C700,100 800,300 900,200" fill="none" stroke="white"
                        stroke-width="1.5" />
                    <path d="M-100,250 C200,200 300,400 500,250 C700,150 800,350 900,250" fill="none" stroke="white"
                        stroke-width="1.2" />
                    <path d="M-100,300 C200,250 300,450 500,300 C700,200 800,400 900,300" fill="none" stroke="white"
                        stroke-width="0.9" />
                    <path d="M-100,350 C200,300 300,500 500,350 C700,250 800,450 900,350" fill="none" stroke="white"
                        stroke-width="0.6" />
                </svg>
                ...
                <div class="overlay-panel overlay-left px-12">
                    <div class="flex flex-col items-center justify-center -mt-8">
                        ...
                        <p class="text-xs text-white/60 mb-5 max-w-xs leading-relaxed">Masuk ke akun Anda untuk
                            melanjutkan pemantauan bencana secara real-time.</p>
                ...
                <div class="overlay-panel overlay-right px-12">
                    <div class="flex flex-col items-center justify-center -mt-8">
                        ...
                        <p class="text-xs text-white/60 mb-5 max-w-xs leading-relaxed">Daftarkan diri Anda sekarang
                            untuk menjadi bagian dari sistem informasi tanggap bencana SIGMA.</p>
